...
! Unterschiede zum internen: 
! implicit none muss ueberall extra bekannt gemacht werden
! ggt muss deklariert werden in Funktionen, die ihn benutzen
! Programmteile unabhängig, kein contains
