...
!|               4. in 5th loop the last digits of all calculations are    |
!|                  calculated and compared                                |
!|               5. most inner 3 loops are manually unrolled               |
!|               6. if "m" > 7 (too big) or = 0 (to small) cycle loop_5    |
!|                                                            (6th loop)   |
!|                                                                         |
!+-------------------------------------------------------------------------+
...
!----------------------
      ...
      integer (kind=ip)  :: k0, k1, k2, k3, k4, k5, k6
...
!---> all permutations of "n","p","h" manually programmed <---
