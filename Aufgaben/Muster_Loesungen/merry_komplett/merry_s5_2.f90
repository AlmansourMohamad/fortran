...
!|               4. loop8 is shortened, i8 and i9 are calculated,          |
!|                  calculations and comparisons are done, i8 and i9 are   |
!|                  reversed, then calcs. and compars. are done again.     |
!|                                                                         |
!+-------------------------------------------------------------------------+
...
!----<>--------<>--------<>--------<>--------<>--------<>--------<>--------<>----
                ...
                loop7: do, i7=0,9    ! loop for "p"
                       ...
                       digits (i7) = .true.
                       s7 = s6 + i7
                       happy = zehntausender(i6) + tausender(i4) + hunderter_zehner(i7) + i3

!----<>--------<>--------<>--------<>--------<>--------<>--------<>--------<>----


                  loop8: do, k8=0,9    ! loop for "n"


                    if ( .not. digits(k8) ) then 
                       i8 = k8
                       exit
                    end if
                                           ...
                                           ! loop for "w"
                  i9 = 45 - s7 - i8        ! calculation of i9 instead of loop
...
!-----------------------------------------------------------------
!---> now exchange i8 and i9 and repeat the calculation again <---
!-----------------------------------------------------------------
