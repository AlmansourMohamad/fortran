...
!|                                                                         |
!| 1st step: all if-questions stay within the innermost loop, but their    |
!|           order is reversed. Now the if's regarding the outermost loop  |
!|           come 1st, then th if's regarding the 2nd loop follow etc.     |
!|                                                                         |
!+-------------------------------------------------------------------------+
